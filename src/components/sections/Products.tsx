  ...
  return (
    <section id="products" ref={ref} className="py-16 md:py-24 bg-gradient-soft">
      <div className="container mx-auto px-4">
        ...
        <div className="flex lg:grid lg:grid-cols-3 gap-4 md:gap-6 max-w-6xl mx-auto overflow-x-auto lg:overflow-visible snap-x snap-mandatory lg:snap-none pb-2 lg:pb-0 -mx-4 px-4 lg:mx-auto lg:px-0">
          {products.map((p, i) => (
            <div
              key={p.id}
