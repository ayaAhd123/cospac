          ...
          >
            ...
            <div className="relative grid md:grid-cols-[1fr_auto] gap-8 items-center text-center md:text-start rtl:md:text-end">
              ...
              <div className="md:col-span-2 flex flex-wrap justify-center gap-3">
                <button type="button" onClick={openOrderForm} className="h-12 px-8 rounded-full bg-gold text-gold-foreground font-black shadow-gold hover:scale-105 transition-smooth">
                  {t.offer.cta}
                </button>
              </div>
            </div>
